...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const subtotalElement = document.querySelector(".total-line:nth-child(1) span:last-child");
    const shippingElement = document.querySelector(".total-line:nth-child(2) span:last-child");
    const taxElement = document.querySelector(".total-line:nth-child(3) span:last-child");
    ...
    function savePaymentData() {
      ...
      if (selectedPaymentMethod === "credit-card") {
        ...
        paymentData.cryptoType = document.querySelector('input[name="crypto-type"]:checked').value;
      }
    }
    ...
    function updateShippingReview() {
      ...
      shippingReview.innerHTML = `
        ...
        <p>${shippingData.address}${shippingData.address2 ? ', ' + shippingData.address2 : ''}</p>
        <p>${shippingData.city}, ${shippingData.state} ${shippingData.zip}</p>
        <p>Email: ${shippingData.email}</p>
        <p>Phone: ${shippingData.phone}</p>
        <p>Shipping: ${shippingData.shipping === 'standard' ? 'Standard Shipping ($9.99)' : 'Express Shipping ($19.99)'}</p>
      `;
    }
    ...
    function updatePaymentReview() {
      ...
      if (paymentData.method === "credit-card") {
        ...
        paymentReview.innerHTML = `
          <p>Cryptocurrency: ${paymentData.cryptoType.charAt(0).toUpperCase() + paymentData.cryptoType.slice(1)}</p>
        `;
      }
    }
    ...
    function setupOrderPlacement() {
      ...
      placeOrderBtn.addEventListener("click", function () {
        ...
        setTimeout(() => {
          ...
          // Show success message
          const checkoutSection = document.querySelector(".checkout-section .container");
          ...
          successMessage.innerHTML = `
            ...
            <p>You will receive your items in ${shippingData.shipping === 'standard' ? '3-5' : '1-2'} business days.</p>
